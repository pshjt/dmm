...
class WxfbMainFrame : public wxFrame
{
	...
	public:
		...
		WxfbMainFrame( wxWindow* parent, wxWindowID id = wxID_ANY, const wxString& title = wxEmptyString, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxSize( 750,875 ), long style = wxDEFAULT_FRAME_STYLE|wxTAB_TRAVERSAL );
