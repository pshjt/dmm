...
#define wxUSE_ON_FATAL_EXCEPTION RELEASE_0
...
#define wxUSE_STACKWALKER RELEASE_0
...
#define wxUSE_DEBUGREPORT RELEASE_0
...
#define wxUSE_EXCEPTIONS    RELEASE_0
...
#define wxUSE_LOG RELEASE_0

// Recommended setting: 1
#define wxUSE_LOGWINDOW RELEASE_0

// Recommended setting: 1
#define wxUSE_LOGGUI RELEASE_0

// Recommended setting: 1
#define wxUSE_LOG_DIALOG RELEASE_0
...
#define wxUSE_CMDLINE_PARSER RELEASE_0
...
#define wxUSE_STREAMS       1 // build errors in wxWidgets 3.1.7 if set to 0, try again in 3.2+
...
#define wxUSE_PRINTF_POS_PARAMS      RELEASE_0
...
//
// Recommended setting: 1 (but can be safely disabled if you don't use it)
#define wxUSE_CONSOLE_EVENTLOOP RELEASE_0
...
#define wxUSE_FILE          1 // build error in 3.1.7 if set to 0
#define wxUSE_FFILE         1 // build error in 3.1.7 if set to 0
...
//
// Recommended setting: 1 (but may be safely disabled if you don't use it)
#define wxUSE_SECRETSTORE   RELEASE_0
...
#define wxUSE_SPELLCHECK RELEASE_0
...
#define wxUSE_TEXTBUFFER    RELEASE_0
...
#define wxUSE_STOPWATCH     RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_DIALUP_MANAGER   RELEASE_0
...
#define wxUSE_SOCKETS       RELEASE_0
...
#define wxUSE_FILESYSTEM    RELEASE_0

// Set to 1 to enable virtual ZIP filesystem (requires wxUSE_FILESYSTEM)
#define wxUSE_FS_ZIP        RELEASE_0

// Set to 1 to enable virtual archive filesystem (requires wxUSE_FILESYSTEM)
#define wxUSE_FS_ARCHIVE    RELEASE_0

// Set to 1 to enable virtual Internet filesystem (requires wxUSE_FILESYSTEM)
#define wxUSE_FS_INET       RELEASE_0

// wxArchive classes for accessing archives such as zip and tar
#define wxUSE_ARCHIVE_STREAMS     RELEASE_0

// Set to 1 to compile wxZipInput/OutputStream classes.
#define wxUSE_ZIPSTREAM     RELEASE_0

// Set to 1 to compile wxTarInput/OutputStream classes.
#define wxUSE_TARSTREAM     RELEASE_0

// Set to 1 to compile wxZlibInput/OutputStream classes. Also required by
// wxUSE_LIBPNG
#define wxUSE_ZLIB          RELEASE_0
...
#define wxUSE_APPLE_IEEE          RELEASE_0

// Joystick support class
#define wxUSE_JOYSTICK            RELEASE_0

// wxFontEnumerator class
#define wxUSE_FONTENUM RELEASE_0

// wxFontMapper class
#define wxUSE_FONTMAP RELEASE_0

// wxMimeTypesManager class
#define wxUSE_MIMETYPE RELEASE_0
...
#define wxUSE_WEBREQUEST RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_PROTOCOL RELEASE_0

// The settings for the individual URL schemes
#define wxUSE_PROTOCOL_FILE RELEASE_0
#define wxUSE_PROTOCOL_FTP RELEASE_0
#define wxUSE_PROTOCOL_HTTP RELEASE_0

// Define this to use wxURL class.
#define wxUSE_URL RELEASE_0
...
#define wxUSE_VARIANT RELEASE_0
...
#define wxUSE_REGEX       RELEASE_0

// wxSystemOptions class
#define wxUSE_SYSTEM_OPTIONS RELEASE_0

// wxSound class
#define wxUSE_SOUND      RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_MEDIACTRL     RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_PROPGRID  RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_WEBVIEW RELEASE_0
...
#define wxUSE_GRAPHICS_CONTEXT RELEASE_0
#else
...
#define wxUSE_POPUPWIN     RELEASE_0
...
#define wxUSE_TIPWINDOW    RELEASE_0
...
#define wxUSE_COLOURPICKERCTRL RELEASE_0    // wxColourPickerCtrl
#define wxUSE_COMBOBOX      RELEASE_0   // wxComboBox
#define wxUSE_COMMANDLINKBUTTON RELEASE_0   // wxCommandLinkButton
#define wxUSE_DATAVIEWCTRL  RELEASE_0   // wxDataViewCtrl
#define wxUSE_DATEPICKCTRL  RELEASE_0   // wxDatePickerCtrl
#define wxUSE_DIRPICKERCTRL RELEASE_0   // wxDirPickerCtrl
#define wxUSE_EDITABLELISTBOX RELEASE_0 // wxEditableListBox
#define wxUSE_FILECTRL      RELEASE_0   // wxFileCtrl
#define wxUSE_FILEPICKERCTRL RELEASE_0  // wxFilePickerCtrl
#define wxUSE_FONTPICKERCTRL RELEASE_0  // wxFontPickerCtrl
...
#define wxUSE_SCROLLBAR     RELEASE_0   // wxScrollBar
#define wxUSE_SEARCHCTRL    RELEASE_0   // wxSearchCtrl
#define wxUSE_SLIDER        RELEASE_0   // wxSlider
#define wxUSE_SPINBTN       RELEASE_0   // wxSpinButton
#define wxUSE_SPINCTRL      RELEASE_0   // wxSpinCtrl
#define wxUSE_STATBOX       1   // wxStaticBox
#define wxUSE_STATLINE      1   // wxStaticLine
#define wxUSE_STATTEXT      1   // wxStaticText
#define wxUSE_STATBMP       1   // wxStaticBitmap
#define wxUSE_TEXTCTRL      1   // wxTextCtrl
#define wxUSE_TIMEPICKCTRL  RELEASE_0   // wxTimePickerCtrl
#define wxUSE_TOGGLEBTN     RELEASE_0   // requires wxButton
#define wxUSE_TREECTRL      1   // wxTreeCtrl
#define wxUSE_TREELISTCTRL  RELEASE_0   // wxTreeListCtrl
...
#define wxUSE_TOOLBAR RELEASE_0
#define wxUSE_TOOLBAR_NATIVE RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_NOTEBOOK RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_LISTBOOK RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_CHOICEBOOK RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_TREEBOOK RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_TOOLBOOK RELEASE_0
...
#define wxUSE_TASKBARICON RELEASE_0
...
#define wxUSE_MINIFRAME RELEASE_0
...
#define wxUSE_COMBOCTRL RELEASE_0
...
#define wxUSE_ODCOMBOBOX RELEASE_0
...
#define wxUSE_BITMAPCOMBOBOX RELEASE_0
...
#define wxUSE_ARTPROVIDER_TANGO RELEASE_0

// Hotkey support (currently Windows only)
#define wxUSE_HOTKEY RELEASE_0
...
#define wxUSE_GEOMETRY            RELEASE_0
...
// depends on it)
#define wxUSE_INFOBAR       RELEASE_0
...
//
// Recommended setting: 1 (but can be safely disabled if you don't use it)
#define wxUSE_PREFERENCES_EDITOR RELEASE_0
...
#define wxUSE_RICHTOOLTIP RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_SPLITTER      RELEASE_0
...
#define wxUSE_VALIDATORS RELEASE_0
...
#define wxUSE_COMMON_DIALOGS RELEASE_0

// wxBusyInfo displays window with message when app is busy. Works in same way
// as wxBusyCursor
#define wxUSE_BUSYINFO      RELEASE_0
...
#define wxUSE_CHOICEDLG     RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_COLOURDLG     RELEASE_0
...
#define wxUSE_FINDREPLDLG       RELEASE_0
...
//
// Recommended setting: 1 (used in the library itself)
#define wxUSE_FONTDLG       RELEASE_0
...
#define wxUSE_TEXTDLG RELEASE_0

// number entry dialog
#define wxUSE_NUMBERDLG RELEASE_0

// credential entry dialog
#define wxUSE_CREDENTIALDLG RELEASE_0

// splash screen class
#define wxUSE_SPLASH RELEASE_0

// wizards
#define wxUSE_WIZARDDLG RELEASE_0
...
//                      use this function
#define wxUSE_ABOUTDLG RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_FILE_HISTORY RELEASE_0
...
#define wxUSE_METAFILE              1 // build error in wxWidgets 3.1.7 if disabled, try again in 3.2+
...
#define wxUSE_MDI RELEASE_0

// Set to 0 to disable document/view architecture
#define wxUSE_DOC_VIEW_ARCHITECTURE RELEASE_0

// Set to 0 to disable MDI document/view architecture
//
// Requires wxUSE_MDI && wxUSE_DOC_VIEW_ARCHITECTURE
#define wxUSE_MDI_ARCHITECTURE    RELEASE_0

// Set to 0 to disable print/preview architecture code
#define wxUSE_PRINTING_ARCHITECTURE  RELEASE_0
...
// otherwise.
#define wxUSE_GLCANVAS       RELEASE_0
...
// smaller library.
#define wxUSE_RICHTEXT       RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_CLIPBOARD     RELEASE_0
...
//
// Recommended setting: 1
#define wxUSE_DRAG_AND_DROP RELEASE_0
...
#ifdef __WXMSW__
#define wxUSE_ACCESSIBILITY RELEASE_0
#else
...
// space)
#define wxUSE_SNGLINST_CHECKER  RELEASE_0

#define wxUSE_DRAGIMAGE RELEASE_0

#define wxUSE_IPC         RELEASE_0
                                // 0 for no interprocess comms
#define wxUSE_HELP        RELEASE_0
...
#define wxUSE_MS_HTML_HELP RELEASE_0


// Use wxHTML-based help controller?
#define wxUSE_WXHTML_HELP RELEASE_0

#define wxUSE_CONSTRAINTS RELEASE_0
                                // 0 for no window layout constraint system

#define wxUSE_SPLINES     RELEASE_0
                                // 0 for no splines

#define wxUSE_MOUSEWHEEL        RELEASE_0
                                // Include mouse wheel support

// Compile wxUIActionSimulator class?
#define wxUSE_UIACTIONSIMULATOR RELEASE_0
...
#define wxUSE_AFM_FOR_POSTSCRIPT RELEASE_0
...
//
// Recommended setting: 1.
#define wxUSE_DC_TRANSFORM_MATRIX RELEASE_0
...
#define wxUSE_LIBPNG        RELEASE_0

// Set to 1 for JPEG format support (requires libjpeg)
#define wxUSE_LIBJPEG       RELEASE_0

// Set to 1 for TIFF format support (requires libtiff)
#define wxUSE_LIBTIFF       RELEASE_0

// Set to 1 for SVG rasterizing support using nanosvg
#define wxUSE_NANOSVG       RELEASE_0

// Set to 1 to use external nanosvg library when wxUSE_NANOSVG is enabled
#define wxUSE_NANOSVG_EXTERNAL 0

// Set to 1 for TGA format support (loading only)
#define wxUSE_TGA           RELEASE_0

// Set to 1 for GIF format support
#define wxUSE_GIF           RELEASE_0

// Set to 1 for PNM format support
#define wxUSE_PNM           RELEASE_0

// Set to 1 for PCX format support
#define wxUSE_PCX           RELEASE_0
...
#define wxUSE_PALETTE       RELEASE_0
...
#define wxUSE_OLE_AUTOMATION RELEASE_0
...
#define wxUSE_POSTSCRIPT_ARCHITECTURE_IN_MSW RELEASE_0
...
#define wxUSE_REGKEY 1 // Build error in v3.1.7 if set to 0, try again in 3.2+
...
#define wxUSE_UXTHEME           1 // Build error in wxWidgets 3.1, should be fixed in 3.2 -> set to 0 there again
...
//
// Recommended setting: 1, set to 0 if your programs never crash
#define wxUSE_CRASHREPORT RELEASE_0
/* --- end MSW options --- */
