...
#define wxUSE_STREAMS       RELEASE_0
...
#define wxUSE_STD_CONTAINERS ALL_1
...
#define wxUSE_FILE          RELEASE_0
#define wxUSE_FFILE         RELEASE_0
...
#define wxUSE_DISPLAY       1 // NOTE: Access violations if set to 0.
...
//
// Recommended setting: 1
#define wxUSE_OLE           1 // NOTE: Problems with system calls on WinXP if set to 0.
...
//
// Recommended setting: 1
#define wxUSE_RICHEDIT2 RELEASE_0
